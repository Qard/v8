...
#define NATIVE_CONTEXT_FIELDS(V)                                               \
  ...
  V(PROMISE_HOOK_INIT_FUNCTION_INDEX, JSFunction, promise_hook_init_function)  \
  V(PROMISE_HOOK_BEFORE_FUNCTION_INDEX, JSFunction,                            \
    promise_hook_before_function)                                              \
  V(PROMISE_HOOK_AFTER_FUNCTION_INDEX, JSFunction,                             \
    promise_hook_after_function)                                               \
  V(PROMISE_HOOK_RESOLVE_FUNCTION_INDEX, JSFunction,                           \
...
#undef NATIVE_CONTEXT_FIELDS_DEF
  ...
  void RunPromiseHook(int type, Handle<JSPromise> promise,
